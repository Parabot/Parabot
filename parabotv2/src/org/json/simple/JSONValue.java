...
public class JSONValue
{
	 ...
	 * <p>
	 * If this object is a Map or a List, and it's also a JSONAware, JSONAware will be considered
	 * firstly.
	 * <p>
	 * DO NOT call this method from toJSONString() of a class that implements both JSONAware and Map
	 * or List with "this" as the parameter, use JSONObject.toJSONString(Map) or
