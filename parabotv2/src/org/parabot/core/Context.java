...
public class Context
{
	...
	/**
	 * Gets ServerProvider info Can be null if this is not a public server provider
	 * 
	...
	/**
	 * Gets the hook parser, may be null if injection is not used or a custom hook parser is used
	 * for injecting
	 * 
	 * @return hook parser
	 */
	...
	/**
	 * Sets the current running script, if a script stops it will call this method with a null
	 * argument
	 * 
	 * @param script
	 */
